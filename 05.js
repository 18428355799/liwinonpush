...
window._agl.push(["ext", {
    xAngeliaLogid: "1786511920962476554",
    bclid: "",
    bdsfrcvid: "A94sJeCCxG3HnZ6uuHKKVyiCwACH6AQX2liC3J"
}]);
!function() {
    "use strict";
    function z(t) {
    ...
    !function() {
        if (!window._agl || !window._agl.isAngelia)
            if (window._bdFcHmtAngelia && window._bdFcHmtAngelia.isAngelia)
                ...
                var t = new I;
                t.push.apply(t, d(window._agl || []).concat([["stopEvents", "input|focus|blur|mousemove|scroll|disarm|hashchange|heartbeat"], ["stopAttrs", "_value|value|placeholder"], ["logUrl", {
                    path: "/log/ocpcagl"
                }], ["getInfoFunc", function(t, e) {
                    var n, r = {};
